            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <i class="fas fa-edit"></i> Oyun Düzenle: {{ $play->name }}
                    </div>

                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.plays.update', $play) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control login-input @error('name') is-invalid @enderror"
                                       id="name" name="name" value="{{ old('name', $play->name) }}" required>
                                @error('name')
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control login-input @error('description') is-invalid @enderror"
                                          id="description" name="description" rows="3">{{ old('description', $play->description) }}</textarea>
                                @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control login-input @error('author') is-invalid @enderror"
                                               id="author" name="author" value="{{ old('author', $play->author) }}">
                                        @error('author')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control login-input @error('director') is-invalid @enderror"
                                               id="director" name="director" value="{{ old('director', $play->director) }}">
                                        @error('director')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-8">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control login-input @error('cast') is-invalid @enderror"
                                               id="cast" name="cast" value="{{ old('cast', $play->cast) }}" placeholder="Virgülle ayırarak yazın">
                                        @error('cast')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control login-input @error('duration') is-invalid @enderror"
                                               id="duration" name="duration" value="{{ old('duration', $play->duration) }}" min="1">
                                        @error('duration')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control login-input @error('venue_id') is-invalid @enderror"
                                            ...
                                            @foreach($venues as $venue)
                                                <option value="{{ $venue->id }}" {{ old('venue_id', $play->venue_id) == $venue->id ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control login-input @error('ticket_price') is-invalid @enderror"
                                               id="ticket_price" name="ticket_price" value="{{ old('ticket_price', $play->ticket_price) }}" step="0.01" min="0">
                                        @error('ticket_price')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="mb-3">
                                <div class="form-check">
                                    ...
                                    <input type="checkbox" class="form-check-input" id="is_active" name="is_active" value="1"
                                        {{ old('is_active', $play->is_active) ? 'checked' : '' }}>
