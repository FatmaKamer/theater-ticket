        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <i class="fas fa-edit"></i> Kullanıcı Düzenle: {{ $user->name }}
                </div>
                    ...
                    <form method="POST" action="{{ route('admin.users.update', $user) }}">
                        ...
                        <div class="mb-3">
                            <label for="password" class="form-label">
                                Şifre <small class="text-muted">(Boş bırakırsanız değişmez)</small>
                            </label>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control login-input @error('role') is-invalid @enderror" 
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('admin.users.index') }}" class="btn-theater-outline">
